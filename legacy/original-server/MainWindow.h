...
private:
    ...
    void showHostIp();
    void appendServerStatus(const QString& message);
    GroupKey groupKeyById(int groupId) const;
private slots:
...
private:
    ...
    std::map<MsgBuilder::UserData, QThread*> usersOnline;
    int createGroupId = 200000;
    int activeConnections = 0;
    std::map<GroupKey, std::vector<QThread*> > groups;
};
